...
## Key tensions
Artists who engage too authentically risk losing mystique — there is a productive distance in the fan relationship that over-familiarity can collapse. Also: building fan relationships off-platform gives artists more control but loses reach. And fan communities on third-party platforms (subreddits, Discord servers) are owned by neither the artist nor the fans — they exist at the platform's discretion and disappear when the platform does.

## Open questions
- What happens to fan communities when the platforms that host them shut down or change their rules? 
- How can artists build meaningful engagement between shows and releases rather than relying on performative social posts? 
- What does genuine continuity in an artist-fan relationship look like, and what tools or models would support it? 
- How can artists make the most of their fandoms without over-extracting from them?